...
export default function WeatherTracker({ onObservationComplete }) {
  ...
  // Traditional weather wisdom database
  const traditionalWisdom = [
    {
      category: 'Animal Behavior',
      signs: [
        'Birds flying low - Rain within 24 hours',
        'Ants moving in lines - Heavy rain approaching',
        'Cattle gathering under trees - Storm coming',
    ...
    },
    {
      ...
      signs: [
        'Leaves turning upward - Heavy rain approaching',
        'Flowers closing during day - Rain coming',
    ...
    },
    {
      ...
      signs: [
        ...
        'Smoke drifting low - Rain approaching',
        'Strong wind from east - Storm coming',
        'Sudden wind calm - Storm eye or change coming',
        'Air feels heavy - Thunderstorm approaching'
      ]
    }
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleWeatherChange('rainfall', e.target.value)}
                placeholder="5.0"
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => handleWeatherChange('cloudCover', e.target.value)}
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                value={traditionalSigns.animalBehavior}
                onChange={(e) => handleTraditionalSignChange('animalBehavior', e.target.value)}
                rows="2"
            ...
            <div>
              ...
              <textarea
                value={traditionalSigns.plantIndicators}
                onChange={(e) => handleTraditionalSignChange('plantIndicators', e.target.value)}
                rows="2"
            ...
            <div>
              ...
              <textarea
                value={traditionalSigns.skyPatterns}
                onChange={(e) => handleTraditionalSignChange('skyPatterns', e.target.value)}
                rows="2"
            ...
            <div>
              ...
              <textarea
                value={traditionalSigns.otherSigns}
                onChange={(e) => handleTraditionalSignChange('otherSigns', e.target.value)}
                rows="2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
              ...
              />
              <label htmlFor="weather-photo-upload" className="cursor-pointer">
