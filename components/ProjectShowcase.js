      ...
      <div className="container-max">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto">
            These projects are not just ideas—they are real-world solutions that are making a 
            tangible difference in the fight against climate change, deforestation, and environmental degradation.
          </p>
        </div>
          ...
          {projects.map((project, index) => (
            <div key={index} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-8 items-center`}>
              <div className="lg:w-1/2">
                <div className="h-64 lg:h-80 bg-gray-200 rounded-lg flex items-center justify-center">
