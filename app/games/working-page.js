...
import {
  Trophy, Star, Coins, Play, Brain, Leaf, Users, Globe,
  CheckCircle, XCircle, Clock, Target, Award, Gamepad2,
  TreePine, Fish, Flower, Sun, Moon, Droplets
} from 'lucide-react'
...
export default function GamesPage() {
  ...
  if (currentGame) {
    return <GameComponent gameId={currentGame} onGameEnd={endGame} />
  }
      ...
      <div className="container-max py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            🎮 Congo Basin Learning Games
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn traditional practices and conservation knowledge through fun, interactive games. 
            Earn credits and unlock achievements while preserving Congo Basin wisdom!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-8">
          {games.map((game) => {
            ...
            return (
              <div key={game.id} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200 hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  {!user && (
                    <p className="text-sm text-gray-500 text-center mt-2">
                      <a href="/login" className="text-primary-600 hover:underline">Login</a> to play and earn credits
                    </p>
                  )}
                </div>
              </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Ancient wisdom for forest conservation and sustainable living</p>
            </div>
            <div className="text-center">
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 text-center shadow-lg">
          ...
          <p className="text-lg text-gray-600 mb-4">You scored {score} out of {questions.length}</p>
          <p className="text-sm text-gray-500 mb-6">Credits earned: {score * 2}</p>
          <button onClick={handleGameEnd} className="btn-primary w-full">Continue</button>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 text-center shadow-lg">
          <div className="text-6xl mb-4">
            {forestHealth > 80 ? '🌳✨' : forestHealth > 60 ? '🌲' : '🌿'}
          </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 text-center shadow-lg">
          ...
          <p className="text-lg text-gray-600 mb-4">You scored {score} out of {challenges.length}</p>
      ...
      <div className="container-max py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            >
              {currentRound + 1 === challenges.length ? 'Finish Game' : 'Next Challenge'}
            </button>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 text-center shadow-lg">
          ...
          <p className="text-lg text-gray-600 mb-4">You identified {score} out of {species.length} correctly</p>
