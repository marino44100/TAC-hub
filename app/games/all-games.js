...
function ForestGuardianGame({ onGameEnd }) {
    ...
    if (showResult) {
        return ( <
            ...
            <
            div className = "text-6xl mb-4" > { forestHealth > 80 ? '🌳✨' : forestHealth > 60 ? '🌲' : forestHealth > 40 ? '🌿' : '🍂' } <
            /div> <
            ...
            div > <
            div className = "text-sm text-gray-600 mb-6" > { forestHealth > 80 && "🎉 Excellent! You're a true Forest Guardian!" } { forestHealth > 60 && forestHealth <= 80 && "👍 Good work! The forest is in safe hands." } { forestHealth > 40 && forestHealth <= 60 && "⚠️ The forest needs more protection." } { forestHealth <= 40 && "🚨 Critical! The forest is in danger." } <
            /div> <
    ...
    return ( <
        ...
        <
        div className = "text-sm text-gray-600" > Scenario { currentScenario + 1 }
        of { scenarios.length } < /div> <
        ...
        span className = { `text-sm font-bold ${forestHealth > 80 ? 'text-green-600' : forestHealth > 60 ? 'text-yellow-600' : 'text-red-600'}` } > { forestHealth } %
        <
        /span> < /
        div > <
...
function SeasonalCalendarGame({ onGameEnd }) {
    ...
    if (showResult) {
        return ( <
            ...
            You scored { score }
            out of { calendarChallenges.length } <
            /p> <
    ...
    return ( <
        ...
        div className = "text-right" >
        <
        div className = "text-sm text-gray-600" > Round { currentRound + 1 }
        of { calendarChallenges.length } < /div> <
        div className = "text-sm text-gray-600" > Score: { score } < /div> < /
        div > <
        /div> < /
        div >
        ...
        className = "btn-primary w-full disabled:opacity-50 disabled:cursor-not-allowed" > { currentRound + 1 === calendarChallenges.length ? 'Finish Game' : 'Next Challenge' } <
        /button> < /
        div > <
        /div> < /
        div > <
...
function SpeciesSpotterGame({ onGameEnd }) {
    ...
    if (showResult) {
        return ( <
            ...
            /p> <
            div className = "text-sm text-gray-600 mb-6" > { score === species.length && "🎉 Perfect! You're a true Congo Basin species expert!" } { score >= 4 && score < species.length && "👍 Excellent knowledge of Congo Basin biodiversity!" } { score >= 2 && score < 4 && "🌿 Good start! Keep learning about our amazing species." } { score < 2 && "📚 There's so much to discover about Congo Basin wildlife!" } <
            /div> <
            button onClick = { handleGameEnd }
            className = "btn-primary w-full" >
            Continue <
    ...
    return ( <
        ...
        div className = "text-right" >
        <
        div className = "text-sm text-gray-600" > Species { currentSpecies + 1 }
        of { species.length } < /div> <
        div className = "text-sm text-gray-600" > Score: { score } < /div> < /
        div > <
        /div> < /
        div >
        ...
        className = "btn-primary w-full disabled:opacity-50 disabled:cursor-not-allowed" > { currentSpecies + 1 === species.length ? 'Finish Game' : 'Next Species' } <
        /button> < /
        div > <
        /div> < /
        div > <
