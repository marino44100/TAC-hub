  ...
  const teamMembers = [
    {
      ...
      bio: 'Climate scientist with 15+ years experience in African environmental policy.',
      image: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=300&h=300&fit=crop&crop=face'
    },
    {
      name: 'Emmanuel Mbeki',
      role: 'Conservation Director',
      bio: 'Former park ranger turned conservation leader, expert in Congo Basin ecosystems.',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face'
    },
    {
      name: 'Dr. Sarah Johnson',
      role: 'Research Director',
      bio: 'Environmental researcher specializing in deforestation monitoring and forest health.',
      image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face'
    },
    {
      name: 'James Okoye',
      role: 'Community Outreach Manager',
      bio: 'Community development specialist working with local stakeholders across Africa.',
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              ...
              Our mission is to create sustainable solutions that protect our environment 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                To serve as the central hub for climate action in Africa, facilitating 
                collaboration between communities, researchers, policymakers, and 
                international partners to address the climate crisis through innovative, 
                locally-driven solutions.
              </p>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Vision</h3>
              <p className="text-lg text-gray-600 leading-relaxed">
                A resilient Africa where thriving communities live in harmony with 
                protected forests and sustainable ecosystems, leading the global fight 
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="container-max text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Together, we can create a sustainable future for Africa and the world. 
