...
export default function FeaturesPage() {
    ...
    return ( <
        ...
        div className = "text-center mb-8" >
        <
        h2 className = "text-2xl font-bold text-gray-900 mb-4" > Designed
        for Everyone < /h2> <
        p className = "text-gray-600 max-w-2xl mx-auto" >
        ...
        <
        JoinCommunityButton className = "bg-primary-600 text-white px-8 py-3 rounded-lg hover:bg-primary-700 transition-colors font-semibold"
        showIcon = { false }
        /> <
